...
abstract class Event {
    ...
    type(): FunctionConstructor {
        return <FunctionConstructor>(this.constructor);
    }
     ...
     */
    get();
    get(fieldSpec: string);
    get(fieldSpec: Array<string>);
    get(fieldSpec: any = ["value"]): number|string|Object {
        let v;
     ...
     */
    value();
    value(fieldSpec: string);
    value(fieldSpec: Array<string>);
    value(fieldSpec: any = ["value"]): number|string|Object {
     ...
     */
    collapse(fieldSpecList: Array<any>,
             columnName: string,
             reducer: (data: Array<number>) => number,
             append: boolean = false): Event {
     ...
     */
    static is(event1: Event, event2: Event) {
    ...
    static merge(events: any, deep: boolean): any {
        if (
     ...
     */
    static combine(events: Event[],
                   reducer: (d: Array<number>) => number,
                   fieldSpec: string|string[]) : Event[];
    static combine(events: Immutable.List<Event>,
                   reducer: (d: Array<number>) => number,
                   fieldSpec: string|string[]) : Immutable.List<Event>;
    static combine(events: any,
                   reducer: (d: Array<number>) => number,
     ...
     */
    static combiner(fieldSpec: string|string[],
                    reducer: (d: Array<number>) => number): Function  {
