...
it(
    "can use TimeSeries.fill() on a more complex example with nested paths",
    () => {
        const ts = new TimeSeries({
            name: "traffic",
            columns: ["time", "direction"],
...
it(
    "can do linear interpolation fill with a pipeline (test_linear_list)",
    () => {
        const ts = new TimeSeries({
            name: "traffic",
            columns: ["time", "direction"],
...
it(
    "can do assymetric linear interpolation (test_assymetric_linear_fill)",
    () => {
        const ts = new TimeSeries({
            name: "traffic",
            columns: ["time", "direction"],
