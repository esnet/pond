...
var TimeSeries = (function () {
                        ...
                        (function () {
                            ...
                            _underscore2["default"].each(seriesPoints, function (point) {
                                ...
                                if (useTimes) {
                                    ...
                                    var timeRange = new (_bind.apply(_range2["default"], [null].concat(_toConsumableArray(i))))();
    ...
    _createClass(TimeSeries, [{
        ...
        key: "isValidNumber",
        value: function isValidNumber(v) {
            return !(_underscore2["default"].isUndefined(v) || _underscore2["default"].isNaN(v) || _underscore2["default"].isNull(v));
        }
    }, {
        key: "numValid",
        value: function numValid(column, func) {
            var _this4 = this;

            var count = 0;
            var c = column || "value";
            this._data.forEach(function (d) {
                var v = _this4.getInternal(d, c, func);
                if (_this4.isValidNumber(v)) {
                    count++;
                }
            });
            return count;
        ...
        value: function sum(column, func) {
            ...
            return this._data.filter(function (d) {
                return _this5.isValidNumber(_this5.getInternal(d, c, func));
            }).reduce(function (memo, d) {
                return +_this5.getInternal(d, c, func) + memo;
            }, 0);
        }
    }, {
        key: "avg",
        ...
        value: function max(column, func) {
            ...
            var max = this._data.filter(function (d) {
                return _this6.isValidNumber(_this6.getInternal(d, c, func));
            }).maxBy(function (d) {
        ...
        value: function min(column, func) {
            ...
            var min = this._data.filter(function (d) {
                return _this7.isValidNumber(_this7.getInternal(d, c, func));
            }).minBy(function (d) {
        ...
        value: function median(column, func) {
            ...
            var sorted = this._data.filter(function (d) {
                return _this8.isValidNumber(_this8.getInternal(d, c, func));
            }).sortBy(function (d) {
                return _this8.getInternal(d, c, func);
            });
        ...
        value: function stdev(column, func) {
            ...
            return Math.sqrt(this._data.filter(function (d) {
                return _this9.isValidNumber(_this9.getInternal(d, c, func));
            }).reduce(function (memo, d) {
                return Math.pow(_this9.getInternal(d, c, func) - mean, 2) + memo;
            }, 0) / this.size());
        }
