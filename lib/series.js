...
var TimeSeries = function () {
    ...
    (0, _createClass3.default)(TimeSeries, [{
        ...
        value: function fill(fieldSpec) {
            ...
            var fillLimit = arguments.length <= 2 || arguments[2] === undefined ? null : arguments[2];

            var collections = this.pipeline().fill(fieldSpec, method, fillLimit).toKeyedCollections();
