...
var TimeSeries = function () {
            ...
            if (_underscore2.default.has(obj, "events")) {
                ...
                (function () {
                    ...
                    var events = points.map(function (point) {
                        ...
                        switch (eventType) {
                            case "time":
                                return new _event.Event(t, d);
                            case "timerange":
                                return new _event.TimeRangeEvent(t, d);
                            case "index":
                                return new _event.IndexedEvent(t, d);
                            default:
    ...
    (0, _createClass3.default)(TimeSeries, [{
                ...
                try {
                    for (var _iterator3 = (0, _getIterator3.default)(series.events()), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                        ...
                        if (event instanceof _event.Event) {
                            ...
                            key = event.index();
                        } else if (event instanceof _event.TimeRangeEvent) {
        ...
        value: function merge(data, seriesList) {
            return TimeSeries.map(data, seriesList, _event.Event.merge);
        }
    }]);
    return TimeSeries;
}();
