...
var TimeSeries = function () {
    ...
    (0, _createClass3.default)(TimeSeries, [{
        ...
        key: "rollupByFixedWindow",
        value: function rollupByFixedWindow(windowSize, aggregation) {
            var collections = this.pipeline().windowBy(windowSize).emitOn("discard").aggregate(aggregation).asEvents().clearWindow().toKeyedCollections();
            return this.setCollection(collections["all"]);
        }
