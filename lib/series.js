...
var TimeSeries = function () {
    ...
    (0, _createClass3.default)(TimeSeries, [{
        ...
        key: "renameColumns",
        value: function renameColumns(renameMap) {
        ...
        value: function fill(_ref) {
            var fieldSpec = _ref.fieldSpec;
            var _ref$method = _ref.method;
            var method = _ref$method === undefined ? "zero" : _ref$method;
            ...
            if (method === "zero" || method === "pad") {
                ...
                fieldSpec.forEach(function (fieldPath) {
                    pipeline = pipeline.fill({ fieldPath: fieldPath, method: method, limit: limit });
                });
            } else {
        ...
        value: function align() {
            ...
            var window = arguments.length <= 1 || arguments[1] === undefined ? "5m" : arguments[1];
            var method = arguments.length <= 2 || arguments[2] === undefined ? "linear" : arguments[2];
            var limit = arguments.length <= 3 || arguments[3] === undefined ? null : arguments[3];

            var collection = this.pipeline().align(fieldSpec, window, method, limit).toKeyedCollections();
        ...
        value: function rate() {
            var fieldSpec = arguments.length <= 0 || arguments[0] === undefined ? "value" : arguments[0];
            var allowNegative = arguments.length <= 1 || arguments[1] === undefined ? true : arguments[1];
