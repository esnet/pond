...
var Offset = function (_Processor) {
    ...
    function Offset(arg1, options, observer) {
        ...
        var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Offset).call(this, arg1, options, observer));
    ...
    (0, _createClass3.default)(Offset, [{
        ...
        value: function addEvent(event) {
            ...
            if (this.hasObservers()) {
                (function () {
                    var selected = _event.Event.selector(event, _this2._fieldSpec);
                    var data = {};
