...
var Derivator = function (_Processor) {
    ...
    function Derivator(arg1, options) {
        ...
        var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Derivator).call(this, arg1, options));
    ...
    (0, _createClass3.default)(Derivator, [{
        ...
        value: function getRate(event) {
            ...
            console.log("::", event.toString(), this._fieldSpec);
