...
var Aggregator = function (_Processor) {
    ...
    function Aggregator(arg1, options, observer) {
        ...
        var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Aggregator).call(this, arg1, options, observer));
    ...
    (0, _createClass3.default)(Aggregator, [{
        ...
        value: function handleTrigger(collection, windowKey) {
            ...
            if (windowKey === "global") {
                ...
                event = new _indexedevent2.default(windowKey, d);
            }
