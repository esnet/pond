...
var Index = (function () {
    ...
    _createClass(Index, [{
        ...
        key: "getBucket",
        value: function getBucket(win, date, key) {
            return new _bucket.IndexedBucket(Index.getIndexString(win, date), key);
        }
    }, {
        ...
        key: "getBucketList",
        value: function getBucketList(win, timerange, key) {
            var indexList = Index.getIndexStringList(win, timerange);
            return _underscore2["default"].map(indexList, function (index) {
                return new _bucket.IndexedBucket(index, key);
            });
        }
    }]);
