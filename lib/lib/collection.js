...
var Collection = function (_Bounded) {
    ...
    (0, _createClass3.default)(Collection, [{
        ...
        value: function sizeValid() {
            var fieldPath = arguments.length <= 0 || arguments[0] === undefined ? "value" : arguments[0];
        ...
        key: "sort",
        value: function sort(fieldSpec) {
            var _this3 = this;

            var fs = _util2.default.fieldPathToArray(fieldSpec);
            return this.setEvents(this._eventList.sortBy(function (event) {
        ...
        key: "first",
        value: function first(fieldPath) {
            return this.aggregate(_functions.first, fieldPath);
        }
        ...
        key: "last",
        value: function last(fieldPath) {
            return this.aggregate(_functions.last, fieldPath);
        }
        ...
        key: "avg",
        value: function avg(fieldPath) {
            return this.aggregate((0, _functions.avg)(), fieldPath);
        }
        ...
        key: "max",
        value: function max(fieldPath) {
            return this.aggregate((0, _functions.max)(), fieldPath);
        }
        ...
        key: "min",
        value: function min(fieldPath) {
            return this.aggregate((0, _functions.min)(), fieldPath);
        }
        ...
        key: "median",
        value: function median(fieldPath) {
            return this.aggregate((0, _functions.median)(), fieldPath);
        }
        ...
        key: "stdev",
        value: function stdev(fieldPath) {
            return this.aggregate((0, _functions.stdev)(), fieldPath);
        }
        ...
        value: function percentile(q, fieldPath) {
            ...
            return this.aggregate((0, _functions.percentile)(q, interp), fieldPath);
        }
        ...
        value: function quantile(n) {
            var column = arguments.length <= 1 || arguments[1] === undefined ? "value" : arguments[1];
            var interp = arguments.length <= 2 || arguments[2] === undefined ? "linear" : arguments[2];
