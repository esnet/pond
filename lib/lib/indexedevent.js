...
var IndexedEvent = function (_Event) {
    ...
    function IndexedEvent(arg1, arg2, arg3) {
        ...
        var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(IndexedEvent).call(this));
        ...
        if (arg1 instanceof IndexedEvent) {
            ...
            _this._d = _this._d.set("index", new _index2.default(avroData.index));
