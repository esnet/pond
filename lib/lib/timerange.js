...
var TimeRange = function () {
    ...
    function TimeRange(arg1, arg2) {
        ...
        if (arg1 instanceof TimeRange) {
            ...
            var rangeArray = this.schema().fromBuffer(arg1);
            ...
            var _rangeArray = arg1;
            this._range = new _immutable2.default.List([new Date(_rangeArray[0]), new Date(_rangeArray[1])]);
        } else {
            var b = arg1;
            var e = arg2;
    ...
    (0, _createClass3.default)(TimeRange, [{
        ...
        value: function schema() {
            return _avscProtocols2.default.parse({ name: "TimeRange", type: "array", items: "long" });
        }
    }, {
        key: "toAvro",
