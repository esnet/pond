    ...
    (0, _createClass3.default)(TimeSeries, [{
        ...
        value: function renameColumns(options) {
            ...
            return this.map(function (event) {
                ...
                if (event instanceof _event2.default) {
                    return new _event2.default(event.timestamp(), d);
                } else if (event instanceof _timerangeevent2.default) {
                    return new _timerangeevent2.default([event.begin(), event.end()], d);
                } else if (event instanceof _indexedevent2.default) {
                    return new _indexedevent2.default(event.index(), d);
                }
            });
        }
        ...
        value: function fixedWindowRollup(options) {
            var windowSize = options.windowSize,
                ...
                _options$toEvents = options.toEvents,
                toEvents = _options$toEvents === undefined ? false : _options$toEvents;
        ...
        value: function hourlyRollup(options) {
            var aggregation = options.aggregation,
                _options$toEvent = options.toEvent,
                toEvent = _options$toEvent === undefined ? false : _options$toEvent;
        ...
        value: function dailyRollup(options) {
            var aggregation = options.aggregation,
                _options$toEvents2 = options.toEvents,
                toEvents = _options$toEvents2 === undefined ? false : _options$toEvents2;
        ...
        value: function monthlyRollup(options) {
            var aggregation = options.aggregation,
                _options$toEvents3 = options.toEvents,
                toEvents = _options$toEvents3 === undefined ? false : _options$toEvents3;
        ...
        value: function yearlyRollup(options) {
            var aggregation = options.aggregation,
                _options$toEvents4 = options.toEvents,
                toEvents = _options$toEvents4 === undefined ? false : _options$toEvents4;
        ...
        value: function timeSeriesListSum(options) {
            return TimeSeries.timeSeriesListReduce((0, _extends3.default)({}, options, { reducer: (0, _functions.sum)() }));
        }
        ...
        value: function timeSeriesListAvg(options) {
            return TimeSeries.timeSeriesListReduce((0, _extends3.default)({}, options, { reducer: (0, _functions.avg)() }));
        }
    }]);
    return TimeSeries;
}();
