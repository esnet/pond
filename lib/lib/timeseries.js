        ...
        */
        ...
        value: function schema() {
            var s = {
                "type": "record",
                "name": "TimeSeries",
                "fields": [].concat((0, _toConsumableArray3.default)(this.metaSchema()), [{ name: "columns", type: { "type": "array", "items": "string" } }, { name: "points", type: {
                        "type": "array",
                        "items": {
                            "type": "record",
                            "name": "Event",
            ...
            console.log((0, _stringify2.default)(s, null, 3));
        ...
        value: function toAvro() {
            ...
            var points = d.points.map(function (point) {
                ...
                return _ref = {}, (0, _defineProperty3.default)(_ref, key, point[0]), (0, _defineProperty3.default)(_ref, "data", data), _ref;
            });
            d.points = points;
