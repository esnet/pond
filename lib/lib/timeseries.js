...
var TimeSeries = function () {
    function TimeSeries(arg) {
        ...
        if (arg instanceof TimeSeries) {
            ...
            var _ret = function () {
                ...
                var obj = void 0;
                try {
                    obj = _this.schema().fromBuffer(arg);
                } catch (err) {
                    console.error("Unable to construct " + _this.constructor.name + " from Avro Buffer: " + err);
                }

                var _obj = obj;
                var columns = _obj.columns;
                var points = _obj.points;
                var _obj$utc = _obj.utc;
                var utc = _obj$utc === undefined ? true : _obj$utc;
                var meta2 = (0, _objectWithoutProperties3.default)(_obj, ["columns", "points", "utc"]); //eslint-disable-line

                var _columns = (0, _slicedToArray3.default)(columns, 1);

                var eventKey = _columns[0];

                var events = points.map(function (point) {
                    var t = point[columns[0]];
                    var d = point.data;
                    var options = utc;
                    var Event = _this.constructor.event(eventKey);
            ...
            if (_underscore2.default.has(_obj2, "events")) {

                //
                // Initialized from an event list
                //

                var _events = _obj2.events;
                var meta1 = (0, _objectWithoutProperties3.default)(_obj2, ["events"]); //eslint-disable-line

                this._collection = new _collection2.default(_events);
                this._data = buildMetaData(meta1);
            } else if (_underscore2.default.has(_obj2, "collection")) {

                //
                // Initialized from a Collection
                //

                var collection = _obj2.collection;
                var meta3 = (0, _objectWithoutProperties3.default)(_obj2, ["collection"]); //eslint-disable-line

                this._collection = collection;
                this._data = buildMetaData(meta3);
            } else if (_underscore2.default.has(_obj2, "columns") && _underscore2.default.has(_obj2, "points")) {
                (function () {
                    ...
                    var columns = _obj2.columns;
                    var points = _obj2.points;
                    var _obj2$utc = _obj2.utc;
                    var utc = _obj2$utc === undefined ? true : _obj2$utc;
                    var meta2 = (0, _objectWithoutProperties3.default)(_obj2, ["columns", "points", "utc"]); //eslint-disable-line

                    var _columns2 = (0, _toArray3.default)(columns);

                    var eventKey = _columns2[0];

                    var eventFields = _columns2.slice(1);
    ...
    (0, _createClass3.default)(TimeSeries, [{
        key: "metaSchema",
        value: function metaSchema() {
            return [{ name: "name", type: "string" }];
        }
    }, {
        key: "keySchema",
        value: function keySchema(eventKey) {
            var Event = this.constructor.event(eventKey);
            return Event.keySchema();
        }
    }, {
        key: "dataSchema",
        value: function dataSchema(eventKey) {
            var Event = this.constructor.event(eventKey);
            return Event.dataSchema();
        }
    }, {
        key: "schema",
        value: function schema(eventKey) {
            var s = {
                type: "record",
                name: "TimeSeries",
                fields: [].concat((0, _toConsumableArray3.default)(this.metaSchema()), [{
                    name: "columns",
                    ...
                    type: {
                        ...
                        items: {
                            type: "record",
                            name: "Event",
                            fields: [this.keySchema(eventKey), { name: "data", type: this.dataSchema(eventKey) }]
                        }
                    }
                }])
            };
            return _avsc2.default.parse(s);
        }
        ...
        value: function toAvro() {
            ...
            var _d$columns = (0, _toArray3.default)(d.columns);

            var eventKey = _d$columns[0];

            var columns = _d$columns.slice(1);
            ...
            var points = d.points.map(function (point) {
                ...
                return _ref = {}, (0, _defineProperty3.default)(_ref, eventKey, point[0]), (0, _defineProperty3.default)(_ref, "data", data), _ref;
            });
            d.points = points;
        ...
        value: function setCollection(collection) {
            var isChronological = arguments.length <= 1 || arguments[1] === undefined ? false : arguments[1];
        ...
        value: function percentile(q, fieldPath) {
            var interp = arguments.length <= 2 || arguments[2] === undefined ? "linear" : arguments[2];
        ...
        value: function quantile(quantity) {
            var fieldPath = arguments.length <= 1 || arguments[1] === undefined ? "value" : arguments[1];
            var interp = arguments.length <= 2 || arguments[2] === undefined ? "linear" : arguments[2];
        ...
        value: function fixedWindowRollup(options) {
            ...
            var _options$toTimeEvents = options.toTimeEvents;
            var toTimeEvents = _options$toTimeEvents === undefined ? false : _options$toTimeEvents;
        ...
        value: function hourlyRollup(options) {
            var aggregation = options.aggregation;
            var _options$toTimeEvents2 = options.toTimeEvents;
            var toTimeEvents = _options$toTimeEvents2 === undefined ? false : _options$toTimeEvents2;
        ...
        value: function dailyRollup(options) {
            var aggregation = options.aggregation;
            var _options$toTimeEvents3 = options.toTimeEvents;
            var toTimeEvents = _options$toTimeEvents3 === undefined ? false : _options$toTimeEvents3;
        ...
        value: function monthlyRollup(options) {
            var aggregation = options.aggregation;
            var _options$toTimeEvents4 = options.toTimeEvents;
            var toTimeEvents = _options$toTimeEvents4 === undefined ? false : _options$toTimeEvents4;
        ...
        value: function yearlyRollup(options) {
            var aggregation = options.aggregation;
            var _options$toTimeEvents5 = options.toTimeEvents;
            var toTimeEvents = _options$toTimeEvents5 === undefined ? false : _options$toTimeEvents5;
        ...
        value: function _rollup(type, aggregation) {
            var toTimeEvents = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];
        ...
        value: function collectByFixedWindow(_ref2) {
