...
var TimeSeries = function () {
        ...
        if (arg instanceof TimeSeries) {
            ...
            var _ret = function () {
                ...
                var _obj = obj,
                    ...
                    meta2 = (0, _objectWithoutProperties3.default)(_obj, ["columns", "points", "utc"]); //eslint-disable-line
    ...
    (0, _createClass3.default)(TimeSeries, [{
        ...
        key: "timeSeriesListAvg",
        value: function timeSeriesListAvg(options) {
            var reducer = _event2.default.avg;
            return TimeSeries.timeSeriesListReduce((0, _extends3.default)({}, options, { reducer: reducer }));
        }
    }]);
    return TimeSeries;
