 ...
 */
function keep() {
    var clean = arguments.length <= 0 || arguments[0] === undefined ? filter.ignoreMissing : arguments[0];
...
function percentile(q) {
    ...
    var clean = arguments.length <= 2 || arguments[2] === undefined ? filter.ignoreMissing : arguments[2];
