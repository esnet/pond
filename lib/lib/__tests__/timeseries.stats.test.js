...
it("can sum the series", () => {
  var series = new _timeseries.default(TIMESERIES_DATA);
...
it("can sum a series with missing data", () => {
  var inSeries = MISSING_DATA_TIMESERIES.clean("in");
  var outSeries = MISSING_DATA_TIMESERIES.clean("out");
...
it("can avg the series", () => {
  var series = new _timeseries.default(STATS_DATA);
...
it("can avg series with deep data", () => {
  var series = new _timeseries.default(availabilitySeries);
...
it("can find the standard deviation and mean of another series", () => {
  var series = new _timeseries.default(STATS_DATA2);
...
it("can find the quantiles of a TimeSeries", () => {
  var series = new _timeseries.default({
    ...
    points: [[1400425951000, 22.3], [1400425952000, 32.4], [1400425953000, 12.1], [1400425955000, 76.8], [1400425956000, 87.3], [1400425957000, 54.6], [1400425958000, 45.5], [1400425959000, 87.9]]
  });
