...
var _derivator = require("./derivator");
...
var Pipeline = function () {
    ...
    (0, _createClass3.default)(Pipeline, [{
        ...
        value: function toKeyedCollections() {
            var result = this.to(_pipelineOutCollection2.default);
            if (result) {
                return result;
            } else {
                return {};
        ...
        key: "fill",
        value: function fill(fieldSpec, method, fillLimit) {
            var p = new _filler2.default(this, {
                fieldSpec: fieldSpec,
                method: method,
                fillLimit: fillLimit,
                prev: this._chainLast()
        ...
        value: function align(fieldSpec, window, method, limit) {
            var p = new _aligner2.default(this, {
                fieldSpec: fieldSpec,
                window: window,
                method: method,
                limit: limit,
