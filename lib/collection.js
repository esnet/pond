...
var Collection = function (_BoundedIn) {
    ...
    (0, _createClass3.default)(Collection, [{
        ...
        key: "percentile",
        value: function percentile(q) {
            var column = arguments.length <= 1 || arguments[1] === undefined ? "value" : arguments[1];
            var interp = arguments.length <= 2 || arguments[2] === undefined ? "linear" : arguments[2];

            return this.aggregate((0, _functions.percentile)(q, interp), column);
        }
        ...
        value: function aggregate(func) {
            ...
            var fs = this._fieldSpecToArray(fieldSpec);
            var result = _event2.default.mapReduce(this.eventListAsArray(), [fs], func, options);
            return result[fs];
        }
    }, {
        key: "isChronological",
