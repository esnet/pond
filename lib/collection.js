...
var Collection = function (_BoundedIn) {
    ...
    (0, _createClass3.default)(Collection, [{
        ...
        value: function sort(fieldSpec) {
            ...
            var fs = _util2.default.fieldSpecToArray(fieldSpec);
            return this.setEvents(this._eventList.sortBy(function (event) {
        ...
        value: function clean(fieldPath) {
            var fs = _util2.default.fieldSpecToArray(fieldPath);
            var filteredEvents = [];
        ...
        key: "first",
        value: function first(fieldSpec) {
        ...
        value: function sum(fieldSpec) {
            return this.aggregate((0, _functions.sum)(), fieldSpec);
        }
        ...
        value: function avg(fieldSpec) {
            return this.aggregate((0, _functions.avg)(), fieldSpec);
        }
        ...
        value: function max(fieldSpec) {
            return this.aggregate((0, _functions.max)(), fieldSpec);
        }
        ...
        value: function min(fieldSpec) {
            return this.aggregate((0, _functions.min)(), fieldSpec);
        }
        ...
        value: function median(fieldSpec) {
            return this.aggregate((0, _functions.median)(), fieldSpec);
        }
        ...
        value: function stdev(fieldSpec) {
            return this.aggregate((0, _functions.stdev)(), fieldSpec);
        }
        ...
        key: "percentile",
        value: function percentile(q, fieldSpec) {
            var interp = arguments.length <= 2 || arguments[2] === undefined ? "linear" : arguments[2];

            return this.aggregate((0, _functions.percentile)(q, interp), fieldSpec);
        }
