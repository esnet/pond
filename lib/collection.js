...
var Collection = (function (_BoundedIn) {
    ...
    _createClass(Collection, [{
        ...
        value: function clean(fieldSpec) {
            ...
            try {
                for (var _iterator5 = _getIterator(this.events()), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                    ...
                    if (_event.Event.isValidValue(e, fieldSpec)) {
        ...
        value: function first() {
            ...
            var collection = this.clean(fieldSpec);
            var e = collection.atFirst();
        ...
        value: function sum() {
            ...
            try {
                for (var _iterator6 = _getIterator(collection.events()), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                    var e = _step6.value;
        ...
        value: function avg() {
            ...
            var count = this.sizeValid(fieldSpec);
        ...
        value: function max() {
            ...
            try {
                for (var _iterator7 = _getIterator(collection.events()), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
                    var e = _step7.value;

                    var v = e.value(fieldSpec);
                    if (!max || max < v) max = v;
                }
            } catch (err) {
        ...
        value: function min() {
            ...
            try {
                for (var _iterator8 = _getIterator(collection.events()), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
                    var e = _step8.value;
        ...
        value: function median() {
            ...
            var collection = this.clean(fieldSpec);
            var sorted = collection._eventList.sortBy(function (d) {
                return d.get("data").getIn(searchKeyPath);
            });

            var i = Math.floor(sorted.size / 2);
            if (sorted.size % 2 === 0) {
                var a = sorted.get(i).get("data").getIn(searchKeyPath);
                var b = sorted.get(i - 1).get("data").getIn(searchKeyPath);
                return (a + b) / 2;
            } else {
        ...
        value: function stdev() {
            ...
            try {
                for (var _iterator9 = _getIterator(collection.events()), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
                    var e = _step9.value;
