...
var CollectionOut = function (_PipelineOut) {
    ...
    function CollectionOut(pipeline, options, callback) {
        ...
        var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(CollectionOut).call(this, pipeline));
        ...
        _this._collector = new _collector2.default({
            ...
            if (_this._callback) {
                _this._callback(collection, windowKey, groupByKey);
            } else {
                _this._pipeline.addResult(windowKey + "-" + groupByKey, collection);
            }
        });
        return _this;
    }
