...
var Aligner = function (_Processor) {
    ...
    function Aligner(arg1, options) {
        ...
        var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Aligner).call(this, arg1, options));
    ...
    (0, _createClass3.default)(Aligner, [{
        ...
        value: function getBoundaries(event) {
            ...
            if (prevIndex !== currentIndex) {
                var range = new _range2.default(this._previous.timestamp(), event.timestamp());
        ...
        value: function interpolateHold(boundary) {
            ...
            var setNone = arguments.length <= 1 || arguments[1] === undefined ? false : arguments[1];
