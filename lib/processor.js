...
var Processor = (function () {
    ...
    _createClass(Processor, [{
        ...
        key: "collect",
        value: function collect(window, observer) {
            var emit = this._emit;
            return this._chain("collector", new _collector2["default"]({ window: window, emit: emit }, observer), END);
        }
    }, {
        key: "binner",
        ...
        key: "convertTo",
        value: function convertTo(eventType, alignment, duration) {
            return this._chain("convert to", new _converter2["default"]({
                type: eventType,
                alignment: alignment,
                duration: duration
            }));
