...
function keep() {
    var clean = arguments.length <= 0 || arguments[0] === undefined ? cleaners.ignoreMissing : arguments[0];
...
function percentile(q) {
    ...
    var clean = arguments.length <= 2 || arguments[2] === undefined ? cleaners.ignoreMissing : arguments[2];
    ...
    return function (values) {
        ...
        var sorted = cleanValues.slice().sort();
