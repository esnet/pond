...
var Filler = function (_Processor) {
    ...
    function Filler(arg1, options) {
        ...
        if (arg1 instanceof Filler) {
            ...
            _this._fillLimit = other._fillLimit;
            ...
            var _options$fillLimit = options.fillLimit;
            var fillLimit = _options$fillLimit === undefined ? null : _options$fillLimit;


            _this._fieldSpec = fieldSpec;
            _this._method = method;
            _this._fillLimit = fillLimit;
        } else {
