...
describe("Time ranges", function () {
    ...
    describe("Range mutation", function () {
        it('can be mutatated to form a new range', function(done) {
            ...
            expect(mutatedRange).to.not.equal(range);
            expect(mutatedRange.end().getTime()).to.equal(newTime.getTime());
            done();
        });
    });

    describe("Range compare", function () {
    ...
    describe("Range compare with time", function () {
